...
const ProductCard: React.FC<{
  ...
  return (
    <div className={`group relative bg-gradient-to-b from-slate-900/90 to-slate-950/90 border rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col transform hover:-translate-y-1 ${
      product.isFree
        ? 'border-emerald-400/70 shadow-emerald-500/30 ring-2 ring-emerald-400/40 animate-wiggle-notice'
        : 'border-emerald-500/30 hover:border-emerald-400/80 hover:shadow-emerald-500/20 animate-ebook-glow'
    }`}>
