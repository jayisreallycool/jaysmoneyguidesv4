...
export type ModalView = 'none' | 'about' | 'privacy' | 'terms' | 'contact' | 'disclaimer' | 'cookie-policy' | 'admin' | 'post-reader' | 'auth' | 'profile' | 'media-database' | 'ebook-viewer' | 'ebook-preview' | 'delete-account';
